---
name: ViewComponent
description: This skill should be used when the user is working on Rails view components, asks about "ViewComponent", "renders_one", "renders_many", "component slots", "component previews", or builds reusable UI components in Rails. Provides conventions and API reference.
version: 1.0.0
---
