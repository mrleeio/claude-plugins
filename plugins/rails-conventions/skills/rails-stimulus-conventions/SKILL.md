...
description: Use when creating or modifying Stimulus controllers in app/components or app/javascript/controllers. Covers thin controllers, Turbo-first patterns, and cleanup requirements.
---
...
- [Turbo-First](references/turbo-first.md) - Prefer Turbo over fetch + manual DOM
- [Lifecycle](references/lifecycle.md) - Connect/disconnect patterns and cleanup
