...
description: Use when creating or modifying database migrations in db/migrate. Covers reversibility, data safety, indexing, and column types.
---
...
- [Data Safety](references/data-safety.md) - Handling existing data patterns
- [Dangerous Operations](references/dangerous-operations.md) - Column removal, renaming, concurrent indexes
